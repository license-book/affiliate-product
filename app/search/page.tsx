  ...
  return <main>
    ...
    <section className="searchPageHero">
      <div className="searchPageInner">
        <form className="searchPageForm" action="/search"><input name="q" defaultValue={query} aria-label="검색어"/><button type="submit">검색</button></form>
        <p><b>‘{query || "상품"}’</b> 검색 결과</p>
      </div>
    </section>
    <section className="searchResultsWrap">
